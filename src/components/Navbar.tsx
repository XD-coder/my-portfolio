        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex w-1/3 items-center space-x-3 flex-shrink-0">
            ...
            >
                ...
                <span className="ml-2 flex items-center font-bold text-xl text-primary">
                  &lt;/&gt;
                </span>
                </div>
            </Link>
          ...
          <div className="flex w-1/3 items-center space-x-3">
            ...
            <div className="hidden md:flex items-center gap-2">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#25D366" stroke="currentColor" strokeWidth="0" className="text-[#25D366] group-hover:scale-110 transition-transform">
            ...
            <div className="flex flex-col h-full w-full p-6">
              ...
              >
                ...
                <div className="flex flex-col space-y-4">
                  <a href="tel:+917206881668" className="flex items-center space-x-3 hover:text-primary transition-colors group">
                  ...
                  <a href="https://wa.me/7206881668" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 hover:text-primary transition-colors group">
                  ...
                  <a href="mailto:kartikey.m1210@gmail.com@gmail.com" className="flex items-center space-x-3 hover:text-primary transition-colors group">
                    <div className="w-10 h-10 rounded-full bg-secondary/50 flex items-center justify-center group-hover:bg-primary/10 transition-colors">
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary">
                        <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                        <polyline points="22,6 12,13 2,6"></polyline>
